  ...
  theme: {
    extend: {
      colors: {
        ...
        'slimetch-primary': '#00d4aa',
        'slimetch-secondary': '#00a888',
        'slimetch-accent': '#1a4d42',
        'slimetch-highlight': '#2a5d52',
        'slimetch-light': '#40e8c8',
        'slimetch-blue': '#00b4d8',
        'slimetch-blue-dark': '#0096b7',
        'slimetch-blue-light': '#40d4ff',
        'slimetch-blue-intense': '#00c9ff',
      },
      boxShadow: {
        'glow-slimetch': '0 0 20px rgba(0, 212, 170, 0.6)',
        'glow-slimetch-intense': '0 0 40px rgba(0, 212, 170, 0.9)',
        'glow-slimetch-subtle': '0 0 15px rgba(0, 212, 170, 0.3)',
